<?php
   ...
   function query($query){
        ...
        if (mysqli_fetch_assoc($query)) {
            echo "
                <script>
                    ...
                    window.location = 'Adminpersonalia.php?page=AdminPersonalia&page2=admin&data=tambah-adm';
                </script>
                    ";
            return false;
        }
    ...
    function editAdmin($data){
        ...
        //             window.location = 'AdminPersonalia.php?page=AdminPersonalia&page2=admin&data=adm';
        //         </script>
        //             ";
        //     return false;
        // }
    ...
    function tambahAnggota($data){
        ...
        if (mysqli_fetch_assoc($query)) {
            echo "
                <script>
                    alert('Username sudah ada');
                    window.location = 'AdminPersonalia.php?page=AdminPersonalia&page2=admin&data=tambah-ang';
                </script>
                    ";
            return false;
        }
