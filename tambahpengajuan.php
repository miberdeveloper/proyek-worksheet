...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Yulyanggareni</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <div class="content-wrapper">
    ...
    <div class="card col-sm-6"> <!-- untuk memberi banyaknya kolom bootstrap -->
        <form action="tambahsqlpengajuan.php" class="inner-login" method="post"> <!-- supaya bisa menginputkan tambahsql.php-->
        ...
        <div class="panel panel-default text-left">
            ...
            <td><input type="text" name="total_pinjam" /></td></center>
            </tr>
            </div>
            ...
            <td><input type="date" name="tgl_pinjam" /></td></center>
            </tr>
            </div>
            <tr>
            ...
            <br>
            <tr><center>
            <p><a href="pengajuanpinjam.php"><b>Back<b></a><p> <!-- kembali ke menu.php -->
  </center></tr>
  </div>
  </div>
  </div>
