...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $result=mysqli_query($conn, "SELECT * FROM jenis_bahan");
	// var_dump($result);
...
<div class="panel panel-default text-left">
   ...
   <center><h2>JENIS BAHAN</h2></center><br>
  <a href="CRUD_jenisbahan.php" class="btn btn-primary " type="submit" style="width: 90px" ><span class="glyphicon glyphicon-plus"></span> Create</a>
    ...
    <tbody>
       ...
       <?php $i=1 ?>
	    ...
	    $koneksi = mysqli_connect("localhost", "root", "", "proyek1");
			  if(isset($_GET['tombolcari'])){
				  $cari = $_GET['cari'];
				  $result = mysqli_query($koneksi ,"select * from jenis_bahan where id like '%".$cari."%'");				
			  }else{
				  $result = mysqli_query($koneksi, "select * from jenis_bahan");		
			  }
      ...
      <tr>
		...
		<div class="btn-group" role="group" aria-label="Basic example">
			<a class="btn btn-success" href="edit_jenisbahan.php?id=<?php echo $row['id'];?>">Edit <!-- untuk ke tampilan edit -->
			<a class="btn btn-danger" href="hapus_jenisbahan.php?id=<?php echo $row['id'];?>">Delete</a></a> <!-- untuk menghapus data -->
		</div>
		</center>
	</td>
