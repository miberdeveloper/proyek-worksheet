<?php 
   $query = query("SELECT a.id as 'idAnggota', a.*, j.* FROM anggota a inner join jenis_user j ON a.jenis_anggota = j.id WHERE j.jenis = 'AdminPersonalia' ORDER BY a.id");
...
<div class="box">
   <div class="box-header">
      <h3 class="box-title">Anggota Personalia</h3>
