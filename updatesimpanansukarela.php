...
$data = query("SELECT * FROM simpanan_sukarela WHERE id='$_GET[id]' ")[0];
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card col-sm-6"> <!-- untuk memberi banyaknya kolom bootstrap -->
        <form action="updatesqlsimpanansukarela.php" class="inner-login" method="post"> <!-- supaya bisa menginputkan tambahsql.php-->
        ...
        <div class="panel panel-default text-left">
            <tr>
            <th colspan="2" scope="row"><h2><center><b>Update Simpanan Sukarela</b></center></h2></th> <!-- judul pada tabel -->
            </tr>
            ...
            <div class="form-group">
            <tr><center>
            <th  class="col-sm-2" scope="row">Total Simpanan</th> <!-- kolom baju -->
            <td><input type="text" name="total" value="<?php echo $data['total'];?>"> 
            </tr></center>
            </div>
            ...
            <p><center><a href="simpanansuka.php"><b>Back<b></a></center><p> <!-- kembali ke menu.php -->
            </tr>
            </div>
            </div>
            </div>
