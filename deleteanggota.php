...
if(isset($_GET['id'])){
    if(empty($_GET['id'])){
        ...
        //query sql hapus data untuk memasukkan data ke database
        $delete = mysqli_query($mysqli,"DELETE FROM anggota WHERE anggota='$_GET[id]'") or die ("Mysql Error : ".mysqli_error($mysqli)); // query sql hapus data
        if($delete){
            include "berhasilhapus.php"; //  berfungsi untuk ngelink ke halaman berhasilhapus.php
        }
    }
}
?>
