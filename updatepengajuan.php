...
$data = query("SELECT * FROM transaksi_pinjam WHERE id='$_GET[id]' ")[0];
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/yuli.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Yulyanggraeni</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="dist/img/yuli.jpg" class="img-circle" alt="User Image">

                <p>
                  Yulyanggraeni - Web Developer
  ...
  <div class="content-wrapper">
    ...
    <div class="card col-sm-6"> <!-- untuk memberi banyaknya kolom bootstrap -->
        <form action="updatesqlpengajuan.php" class="inner-login" method="post"> <!-- supaya bisa menginputkan tambahsql.php-->
        ...
        <div class="panel panel-default text-left">
            <tr>
            <th colspan="2" scope="row"><h2><center><b>Update Transaksi Pengajuan</b></center></h2></th> <!-- judul pada tabel -->
            </tr>
            ...
            <td><input type="text" name="id_anggota" value="<?php echo $data['id_anggota'];?>"> 
            </tr></center>
            </div>

            <div class="form-group">
            <tr><center>
            <th  class="col-sm-2" scope="row">Total Pinjam</th> <!-- kolom baju -->
            <td><input type="text" name="total_pinjam" value="<?php echo $data['total_pinjam'];?>"> 
            </tr></center>
            </div>

            <div class="form-group">
            <tr><center>
            <th  class="col-sm-2" scope="row">Tanggal Pinjam</th> <!-- kolom baju -->
            ...
            <p><center><a href="pengajuanpinjam.php"><b>Back<b></a></center><p> <!-- kembali ke menu.php -->
            </tr>
            </div>
            </div>
            </div>
