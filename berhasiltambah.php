...
<div class="container"> 
<div class="jumbotron"> 
    <h2 class="display-4">Data Berhasil Ditambahkan!!!</h2> <!-- isi dari class jumbotron -->
    <hr class="my-4">
    <a class="btn btn-info" href="pendaftarananggota.php" role="button">BACK</a> <!-- tampilan back bewarna hijau -->
    <p>
