...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card col-sm-6"> <!-- untuk memberi banyaknya kolom bootstrap -->
        <form action="registersqlanggotasuka.php" class="inner-login" method="post"> <!-- supaya bisa menginputkan tambahsql.php-->
        ...
        <tr>
            ...
            <br>
            <tr><center>
            <p><a href="simpanansuka.php"><b>Back<b></a><p> <!-- kembali ke menu.php -->
  </center></tr>
  </div>
  </div>
  </div>
