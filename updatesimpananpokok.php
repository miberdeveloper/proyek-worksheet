...
$data = query("SELECT * FROM simpanan_pokok WHERE id='$_GET[id]' ")[0];
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card col-sm-6"> <!-- untuk memberi banyaknya kolom bootstrap -->
        <form action="updatesqlsimpananpokok.php" class="inner-login" method="post"> <!-- supaya bisa menginputkan tambahsql.php-->
        ...
        <div class="panel panel-default text-left">
            <tr>
            <th colspan="2" scope="row"><h2><center><b>Update Simpanan Pokok</b></center></h2></th> <!-- judul pada tabel -->
            </tr>
            ...
            <p><center><a href="simpananpokok.php"><b>Back<b></a></center><p> <!-- kembali ke menu.php -->
            </tr>
            </div>
            </div>
            </div>
