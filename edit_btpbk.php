...
$data = query("SELECT * FROM transaksi_masuk_bahan_baku WHERE id='$_GET[id]' ")[0];
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card col-sm-6"> <!-- untuk memberi banyaknya kolom bootstrap -->
        <form action="edit_prosesbtpbk.php" class="inner-login" method="post"> <!-- supaya bisa menginputkan tambahsql.php-->
            <tr>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <tr><center>
            <th  class="col-sm-2" scope="row">ID Bahan Baku</th> <!-- kolom baju -->
            <td><input type="text" name="id_bahan_baku" value="<?php echo $data['id_bahan_baku'];?>"> 
            </tr></center>
            </div>
            ...
            <p><center><a href="btpbk.php"><b>Back<b></a></center><p> <!-- kembali ke menu.php -->
            </tr>
